...
**Entry:** Monitoring -> App Allowlist -> **Browse App Catalog** tab
...
**Entry:** Monitoring -> App Allowlist -> **Discovered in Your Org** tab
...
**Entry:** Monitoring -> App Allowlist -> search box (any tab)
...
**Entry:** Monitoring -> App Allowlist -> **Current Allowlist** tab
...
8. Configure non_allowed_app_threshold_minutes in monitoring settings (Phase 1 lightweight detection)
9. Roll out agent to remaining employees
   (Phase 2: Create non_allowed_app exception rule in Exception Engine for configurable rules)
```
...
- [[Userflow/Exception-Engine/exception-rule-setup|Exception Rule Setup]] - Phase 2: configure non_allowed_app rule via Exception Engine
