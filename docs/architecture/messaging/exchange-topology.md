...
- [[event-catalog]] — full list of all domain events and their consumers
- [[error-handling]] — retry policies, dead-letter handling, idempotency
- [[shared-kernel]] — DomainEvent and IntegrationEvent base classes
- [[module-boundaries]] — when to use sync vs async communication
