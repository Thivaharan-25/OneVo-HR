...
- [[documents]] — document module architecture
- [[notifications]] — notification module architecture
- [[grievance]] — grievance module architecture
- [[expense]] — expense module architecture
- [[configuration]] — configuration module architecture
- [[calendar]] — calendar module architecture
...
- [[multi-tenancy]] — tenant-scoped settings, overrides, and integration connections
- [[WEEK1-infrastructure-setup]] — industry profile seeding relies on initial tenant provisioning
- [[WEEK1-shared-platform]] — notification templates and channels scaffolded in Week 1, enhanced here
- [[WEEK3-leave]] — Calendar module provides ICalendarConflictService used by leave
- [[WEEK4-exception-engine]] — notifications module delivers exception alerts (new event types added here)
- [[WEEK4-productivity-analytics]] — notifications module delivers report-ready events
- [[WEEK2-core-hr-profile]] — People Sync bridge reads employee data
