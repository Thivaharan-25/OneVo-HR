...
- Active presence session -> [[Userflow/Time-Attendance/presence-session-view|Presence Session View]]
- Shift with break duration defined -> [[Userflow/Time-Attendance/shift-schedule-setup|Shift Schedule Setup]]
...
- **API:** `GET /api/v1/time-attendance/breaks/{employeeId}?date={date}`
