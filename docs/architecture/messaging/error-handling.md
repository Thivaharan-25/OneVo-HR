...
- [[event-catalog]] — which events are critical vs non-critical
- [[exchange-topology]] — outbox pattern and RabbitMQ topology
- [[observability]] — distributed tracing for event flows
- [[logging-standards]] — event handler error logging
