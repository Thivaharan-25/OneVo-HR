...
Daily, weekly, and monthly monitoring reports with activity rate, productivity score basis, data coverage, trend analysis, and CSV/Excel export.
...
```
+-------------------------------------------------------------+
| "Monitoring Reports"  [Daily | Weekly | Monthly] [Export v]  |
+-------------------------------------------------------------+
| [Date Range Picker] [Department Filter v]                   |
+----------+----------+----------+----------+----------------+
...
| Tab | API |
|:----|:----|
| Daily | `GET /analytics/daily/{employeeId}` or `GET /analytics/monitoring?date=X` |
