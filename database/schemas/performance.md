...
**Foreign Keys:** `position_id` -> [[database/schemas/org-structure#`positions`|positions]], `current_holder_id` -> [[database/schemas/core-hr#`employees`|employees]], `successor_id` -> [[database/schemas/core-hr#`employees`|employees]]
