...
**Area:** Monitoring -> Employee (`/monitoring/employees/[employeeId]`)  
**Trigger:** User clicks an employee card on the Presence screen  
**Required Permission:** `monitoring:view` (view); `monitoring:view` (view another employee's activity)
...
[Avatar] Sarah Johnson - Senior Engineer   o Online
Productivity this week: ########-- 82%    Exception: None

------------------------------------------
Filters: [Date Range v]  [Task v]  [Project v]
------------------------------------------
...
| Section | Source |
|---|---|
| Online status, break/clock events | time-attendance module |
...
2. System navigates to `/monitoring/employees/[employeeId]`
