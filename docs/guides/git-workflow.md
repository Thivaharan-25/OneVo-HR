...
- [[coding-standards]] — code conventions and naming
- [[ci-cd-pipeline]] — automated build and deploy pipeline
- [[module-boundaries]] — PR review checklist for boundary violations
- [[rules]] — AI agent rules for code generation
