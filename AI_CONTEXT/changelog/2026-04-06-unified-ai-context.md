...
- **Merged:** All three `known-issues.md` files -> `AI_CONTEXT/known-issues.md`
  - Sections: General/Backend, Monitoring, Payroll, Workflow Engine, Time Off, Frontend/API Integration, Desktop Agent (Win32, MAUI, SQLite, Network, Device JWT, Idle Detection, Meeting Detection, Installation)
