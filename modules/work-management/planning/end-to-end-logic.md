# Planning (Phase 2) - End-to-End Logic

**Module:** WorkSync
**Feature:** Planning (Phase 2: Planner, Boards, Advanced Roadmaps)

---
## Phase Guard

This is a deferred Phase 2 design reference. Do not build these routes, handlers, pages, navigation items, or API integrations in Phase 1. Phase 1 Work uses Projects, Work Items, Documents, Project Members, Project Settings, and Worklogs only.
...
POST /api/v1/workspaces/{wsId}/roadmaps/{rmId}/items
  ...
  -> AddRoadmapItemHandler
    ...
    -> 3. Verify entity belongs to a project in the resolved Phase 2 planning workspace scope
