...
- [[shared-platform]] — workflow engine for offboarding approvals
- [[multi-tenancy]] — tenant-scoped lifecycle data
- [[WEEK1-shared-platform]] — workflow engine used for offboarding (built Week 1)
- [[WEEK2-core-hr-profile]] — lifecycle events mutate employee profile data
- [[WEEK4-payroll]] — EmployeeTerminated triggers final payroll run
