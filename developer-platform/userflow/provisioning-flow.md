...
|:---|:---|:---|
| **HR Management** | Core HR, Leave Management, Calendar | Performance, Payroll, Skills, Learning, Recruitment, Grievance, Expense are Phase 2 — not shown |
| **Workforce Intelligence** | Activity Monitoring, Workforce Presence, Identity Verification, Exception Engine, Productivity Analytics | App Usage Tracking is part of Activity Monitoring. Agent Gateway is infrastructure — not a sellable module. |
| **WorkSync** | Work Management, Chat, Chat AI, Documents, Reports, GitHub Integration | Projects & Sprints, OKR, and Roadmaps are features within Work Management, not separate sellable modules. Chat and Chat AI are separately sellable. |
...
| Leave Approval | "Leave Approval Flow" | Radio | Yes | Default hierarchy resolver, Auto-approved, Custom workflow resolver | Default for new employees |
...
4. Leave policy template → writes `leave_types` + `leave_policies` and assignment rows
