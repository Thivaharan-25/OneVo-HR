...
**Location:** `tests/ONEVO.Tests.Unit/Modules/TimeAttendance/PresenceReconciliationServiceTests.cs`
...
public class PresenceReconciliationServiceTests
{
    ...
    [Fact]
    public async Task On_time_off_status_from_time_off_module()
    {
        // Arrange
        // ... setup mocks for on Time Off status from Time Off module
...
| On Time Off status from Time Off module | Unit | Status = on_leave |
