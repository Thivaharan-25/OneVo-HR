...
Sprint planning must surface HR availability. If assigned employees are on approved leave or blocked by calendar, the planner sees the warning before activating the sprint.
...
5. System surfaces leave/calendar assignment warnings for tasks assigned to unavailable employees.
...
| Leave + Calendar | Planning shows assignment availability warnings before sprint activation |
