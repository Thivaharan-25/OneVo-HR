...
| Session | UUID | 24 hours | `user_sessions` table | Extended on activity |
...
| Device tracking | `user_sessions.device_type` + `ip_address` | Anomaly detection |

## Related

- [[multi-tenancy]] — how JWT tenant_id flows through the system
- [[compliance]] — GDPR consent, session security requirements
- [[data-classification]] — PII in session and auth data
- [[module-catalog]] — Auth module event publishing
- [[shared-kernel]] — ICurrentUser, RequirePermissionAttribute
- [[WEEK1-auth-security]] — Week 1 implementation task
