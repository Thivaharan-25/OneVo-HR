...
Handles authentication (JWT RS256), authorization (RBAC with 90+ permissions), session management, MFA, audit logging, and G[[auth]]DPR consent tracking. Provides the security backbone for the entire platform.
