...
**Action:** `GET /admin/v1/analytics/platform`
**Expected:** HTTP 403
...
**Action:** `GET /admin/v1/analytics/platform?from=...&to=...`
...
**Setup:** `tenant_module_entitlements` has 30 tenants with `chat_ai` in `active` status, 5 in `trial`
**Action:** `GET /admin/v1/analytics/modules`
**Expected:**
- `chat_ai.active_tenants = 30`
- `chat_ai.trial_tenants = 5`
