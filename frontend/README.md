...
**Angular 21** | TypeScript | Angular Material | Tailwind CSS v4 | Angular Signals | Angular Router | Reactive Forms + Zod | SignalR | Customer app + internal dev console monorepo

Two apps: `customer-app` and internal `dev-console`, sharing a `shared` Angular library.
...
- [[frontend/cross-cutting/error-monitoring|Error Monitoring]] - Error monitoring provider (not yet selected), PII scrubbing, alert rules
