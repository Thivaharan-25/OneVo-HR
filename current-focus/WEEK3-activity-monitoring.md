...
- [[agent-gateway]] — data source (raw activity from desktop agent)
- [[configuration]] — feature toggles gate processing
- [[exception-engine]] — consumes IActivityMonitoringService for rule evaluation
- [[data-classification]] — screenshots are RESTRICTED
- [[multi-tenancy]] — tenant-configurable application categories and retention policies
- [[WEEK1-shared-platform]] — agent gateway is the data ingestion source
- [[WEEK2-workforce-presence-biometric]] — PresenceSessionEnded triggers activity pipeline
- [[WEEK4-exception-engine]] — reads IActivityMonitoringService for low_activity, excess_idle, unusual_pattern rules
- [[WEEK4-productivity-analytics]] — aggregates from activity_daily_summary (never raw snapshots)
