# WorkSync Integration Automation

**Area:** WorkSync -> Integrations  
**Trigger:** Workspace admin connects a code repository or configures automation  
...
- **UI:** WorkSync -> Workspace Settings -> Integrations
...
### Step 5: Evaluate Automation Rules
