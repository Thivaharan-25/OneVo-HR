...
**Pillar:** 3 (WorkSync)
**Owner:** Dev 4 (HR additions) / Dev 8 (WorkSync Collaboration)
**Tables:** 9
...
| **Depends on** | WorkSync Foundation | `workspaces`, `projects` | WorkSync document scope |
...
- [[modules/work-management/collaboration/overview|WorkSync Collaboration]] — wiki_pages and task_documents context
