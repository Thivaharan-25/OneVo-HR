...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: '/workforce',             element: <ProtectedRoute permission="workforce:view"><P><div>Workforce</div></P></ProtectedRoute> },
      { path: '/workforce/:employeeId', element: <ProtectedRoute permission="workforce:view"><P><div>Employee Activity</div></P></ProtectedRoute> },
      ...
      { path: '/workforce/projects/:id/sprints', element: <ProtectedRoute permission="sprints:read"><P><div>Sprints</div></P></ProtectedRoute> },
      { path: '/workforce/projects/:id/roadmap', element: <ProtectedRoute permission="sprints:read"><P><ProjectRoadmapPage /></P></ProtectedRoute> },
      { path: '/workforce/my-work',  element: <ProtectedRoute permission="tasks:read"><P><div>My Work</div></P></ProtectedRoute> },
      { path: '/workforce/planner',  element: <ProtectedRoute permission="sprints:read"><P><div>Planner</div></P></ProtectedRoute> },
      { path: '/workforce/goals',    element: <ProtectedRoute permission="okr:read"><P><div>Goals</div></P></ProtectedRoute> },
      { path: '/workforce/goals/:id',element: <ProtectedRoute permission="okr:read"><P><div>Goal</div></P></ProtectedRoute> },
      { path: '/workforce/docs',     element: <ProtectedRoute permission="documents:read"><P><div>Docs</div></P></ProtectedRoute> },
      { path: '/workforce/docs/:id', element: <ProtectedRoute permission="documents:read"><P><div>Doc</div></P></ProtectedRoute> },
      ...
      { path: '/calendar/schedule',   element: <ProtectedRoute permission="calendar:read"><P><div>Schedule</div></P></ProtectedRoute> },
      { path: '/calendar/attendance', element: <ProtectedRoute permission="attendance:read"><P><div>Attendance</div></P></ProtectedRoute> },
      { path: '/calendar/overtime',   element: <ProtectedRoute permission="attendance:read"><P><div>Overtime</div></P></ProtectedRoute> },
      ...
      { path: '/admin/users',      element: <ProtectedRoute permission="users:manage"><P><div>Users</div></P></ProtectedRoute> },
      { path: '/admin/roles',      element: <ProtectedRoute permission="roles:manage"><P><div>Roles</div></P></ProtectedRoute> },
      { path: '/admin/audit',      element: <ProtectedRoute permission="settings:system"><P><div>Audit</div></P></ProtectedRoute> },
      { path: '/admin/agents',     element: <ProtectedRoute permission="agent:manage"><P><div>Agents</div></P></ProtectedRoute> },
      { path: '/admin/agents/:id', element: <ProtectedRoute permission="agent:manage"><P><div>Agent</div></P></ProtectedRoute> },
      { path: '/admin/devices',    element: <ProtectedRoute permission="settings:device"><P><div>Devices</div></P></ProtectedRoute> },
      { path: '/admin/compliance', element: <ProtectedRoute permission="settings:system"><P><div>Compliance</div></P></ProtectedRoute> },
...
const PILLARS = [
  ...
  { id: 'workforce', icon: LayoutDashboard,  route: '/workforce',     permission: 'workforce:view',  hasPanel: true },
...
const ADMIN_PILLARS = [
  { id: 'admin',    icon: Shield,   route: '/admin/users',    permission: 'users:read',    hasPanel: true },
...
const PANEL_ITEMS: Record<string, { label: string; route: string; permission: string | null }[]> = {
  ...
  workforce: [
    { label: 'Presence',   route: '/workforce',            permission: 'workforce:view' },
    ...
    { label: 'Planner',    route: '/workforce/planner',    permission: 'sprints:read' },
    { label: 'Goals',      route: '/workforce/goals',      permission: 'okr:read' },
    { label: 'Docs',       route: '/workforce/docs',       permission: 'documents:read' },
  ...
  calendar: [
    ...
    { label: 'Schedules',   route: '/calendar/schedule',   permission: 'calendar:read' },
    { label: 'Attendance',  route: '/calendar/attendance', permission: 'attendance:read' },
    { label: 'Overtime',    route: '/calendar/overtime',   permission: 'attendance:read' },
  ],
  admin: [
    { label: 'People Access', route: '/admin/users',      permission: 'users:manage' },
    { label: 'Permissions',   route: '/admin/roles',      permission: 'roles:manage' },
    { label: 'Activity Trail',route: '/admin/audit',      permission: 'settings:system' },
    { label: 'Agents',        route: '/admin/agents',     permission: 'agent:manage' },
    { label: 'Devices',       route: '/admin/devices',    permission: 'settings:device' },
    { label: 'Data & Privacy',route: '/admin/compliance', permission: 'settings:system' },
  ],
  settings: [
