...
- [[exception-rules]] — Configurable anomaly detection rules with threshold JSON
- [[evaluation-engine]] — Hangfire-driven rule evaluation against activity and presence data
- [[alert-generation]] — Alert creation, deduplication, evidence snapshots — frontend: [[alert-generation/frontend]]
- [[escalation-chains]] — Time-based escalation routing by severity

---

## Related

- [[multi-tenancy]] — All rules, alerts, and schedules are tenant-scoped
- [[event-catalog]] — `ExceptionAlertCreated`, `AlertEscalated`, `AlertAcknowledged`
- [[error-handling]] — Invalid threshold JSON skips rule with warning log
- [[compliance]] — Alert acknowledgement audit trail
- [[WEEK4-exception-engine]] — Implementation task file
