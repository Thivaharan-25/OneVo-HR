...
| Payment Gateway Configs | Paddle/PayHere credentials with account verification | `payment_gateway_configs` |
...
### Payment Gateway
- Configure global Paddle/PayHere credentials with account verification before save
...
| Route | Permission |
|---|---|
| `/platform/settings` | `platform.system_config.read` |
