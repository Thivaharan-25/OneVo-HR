...
| Agent Version | Installed agent version with badge: Up to date (green) / Outdated (orange) / Unsupported (red) |
...
| Agent Version | All / Up to date / Outdated / Unsupported |
| Deployment Ring | All / Internal / Beta / GA |
