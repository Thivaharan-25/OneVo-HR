...
- [[compliance]] — GDPR/PDPA requirements for data handling
- [[auth-architecture]] — session data and PII in JWT
- [[logging-standards]] — PII scrubbing patterns
- [[shared-kernel]] — IEncryptionService for AES-256
- [[known-issues]] — encrypted fields and JSONB columns
