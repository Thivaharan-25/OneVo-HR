...
- Backend auth architecture: `docs/security/auth-architecture.md`
- API client implementation: `frontend/docs/architecture/api-integration.md`
- Permission system: `frontend/docs/security/rbac-frontend.md`
