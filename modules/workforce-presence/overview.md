...
- [[presence-sessions]] — Unified presence (one row/employee/day from biometric + agent + manual) — frontend: [[presence-sessions/frontend]]
- [[device-sessions]] — Device active/idle cycle tracking (multiple rows/day per laptop)
- [[break-tracking]] — Break records with auto-detection from agent idle threshold
- [[shifts-schedules]] — Shift definitions, weekly schedule patterns, employee assignments
- [[overtime]] — Overtime request and approval workflow
- [[attendance-corrections]] — Manager corrections to presence data

---

## Related

- [[multi-tenancy]] — All presence data is tenant-scoped
- [[event-catalog]] — `PresenceSessionStarted`, `PresenceSessionEnded`, `BreakExceeded`, `OvertimeRequested`
- [[error-handling]] — Deduplication of biometric + agent data in reconciliation job
- [[compliance]] — Presence history for payroll and legal record-keeping
- [[migration-patterns]] — `presence_sessions` UNIQUE on `(tenant_id, employee_id, date)`
- [[WEEK2-workforce-presence-setup]] — Presence and shift setup task file
- [[WEEK2-workforce-presence-biometric]] — Biometric integration task file
