...
Process payroll runs, review calculations, and approve for payment. Reads actual worked hours from Time & Attendance.
...
| +-----------+------------+----------+----------+----------+ |
| | Mar 2026  | Mar 1-31   | 487      | $1.2M    | [pending] Draft  | |
| | Feb 2026  | Feb 1-28   | 485      | $1.18M   | [ok] Paid   | |
| | Jan 2026  | Jan 1-31   | 482      | $1.15M   | [ok] Paid   | |
| +-----------+------------+----------+----------+----------+ |
| Pagination                                                  |
+-------------------------------------------------------------+
```
...
+----------+----------+----------+----------+----------------+
| [Search Employee] [Department v] [Variance v]              |
+-------------------------------------------------------------+
| Payslip Table                                              |
| +------+------+--------+----------+--------+-------------+ |
| | Name | Dept | Gross  | Deductions| Net   | Variance    | |
| +------+------+--------+----------+--------+-------------+ |
| | J.D. | Eng  | $8,500 | $2,125   | $6,375| +$200 [warning]    | |
...
| Worked hours | Fetched by backend from TimeAttendance (not directly by frontend) |

## Workflow

1. **Create run** -> Draft status, select period
2. **Calculate** -> Backend pulls worked hours from TimeAttendance, applies salary structures, deductions, tax
